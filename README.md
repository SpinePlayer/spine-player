...
> - 可选webgl/canvas2d/auto渲染方式，默认auto(优先webgl、自动降级canvas2d)
> - 支持Shader滤镜: 内置常用滤镜效果，同时支持自定义FragmentShader代码传入。
> - 丰富的 API: 提供更加简洁的使用api，如动画切换、皮肤和插槽更换等。
> - 纹理压缩支持：支持astc格式的ktx2文件
